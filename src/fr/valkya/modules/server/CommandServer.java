package fr.valkya.modules.server;
...
public class CommandServer extends Command implements TabExecutor
{
    ...
    {
        super( "server", "valkya.proxy.server" );
    }
    ...
    public void execute(CommandSender sender, String[] args)
    {
        ...
        } else
        {
            ...
            {
            	player.sendMessage(new TextComponent(ChatColor.GOLD + "Valkya »" + ChatColor.YELLOW + " Connexion au serveur " + server.getName()));
